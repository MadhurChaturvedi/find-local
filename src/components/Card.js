        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          <div style={{ paddingLeft: 50 }} className="box">
            ...
            >
              ...
              >
               <h5> On the other hand, we denounce with righteous indignation and
                ...
                <h5 target="_blank">Address -  {address}</h5>
                </div>
              </div>
              <button
                class="btn"
              ...
              <div className="price" style={{paddingTop:5 , marginBottom:15}}>
